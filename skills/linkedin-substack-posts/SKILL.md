...
3. **No direct "AAS Studio" mention in the post body.** Talk about advantages, dangers, and concepts. The product appears as a concrete example only when unavoidable, and never as the headline. Mention the *feature pattern*, not the *product name*.
